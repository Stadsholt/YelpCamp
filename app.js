...
const sessionConfig = {
    store,
    name:'VIEWENGINE',  // Give randomname, so others have harder time finding it
    secret,
    resave: false,
...
// Bunch of helmet stuff. Approved sites
const scriptSrcUrls = [
    ...
    helmet.contentSecurityPolicy({
        directives: {
            ...
            imgSrc: [
                ...
                "blob:",
                "data:",
                "https://res.cloudinary.com/douqbebwk/", // Cloudinary account
                "https://res.cloudinary.com/dad3ddihu/", 
